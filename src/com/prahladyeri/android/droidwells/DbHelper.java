...
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) 
	{
		...
		db.execSQL("CREATE TABLE DAYENTRY(ID INTEGER PRIMARY KEY, SITE_ID INTEGER, FDATE DATE, TP INTEGER, CP INTEGER, CHK INTEGER, FLW INTEGER, LP INTEGER, TEMP INTEGER, MCF INTEGER, TOTAL INTEGER, COMMENT TEXT, DIFF INTEGER, FOREIGN KEY(SITE_ID) REFERENCES SITES(ID));");
